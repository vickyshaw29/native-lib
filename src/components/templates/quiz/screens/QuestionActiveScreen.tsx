...
type QuestionScreenPropsT = { activeQuestionId: string, quizData: any, giveAnswer: any }
const Quiz = ({ activeQuestionId, giveAnswer, quizData }: QuestionScreenPropsT) => {
    ...
    const answersData = QuizUtils.getAnswers({ quizData, questionId: activeQuestionId })
    ...
    const answersComponents = React.useMemo(() => {
        ...
        return shuffledAnswersKeys.map((answerId: string) => {
            ...
            const answer = QuizUtils.getAnswers({ quizData, questionId: activeQuestionId})[answerId]

            return <Answer key={answerId} answer={answer} isSelected={isSelected} isDisabled={isDisabled} onSelect={onSelect} />
        })
